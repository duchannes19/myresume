...
import report from '../../hciw/Gym_Tracker.pdf';
...
function GymTracker() {
	...
	const images = useMemo(() => (
		projectGalleries.hciw.gallery.map(({ large, thumb, alt }) => ({
	...
	return (
		<>
			<h3 className='center-title'>Gym Tracker</h3>
			<div className='project-description'>
				<Trans i18nKey="hciw.description" components={{ b: <b /> }} />
			</div>
			<div style={{ marginTop: '2rem' }}>
				<Trans i18nKey="hciw.d.download" components={{ b: <b /> }} />
			</div>
			<Stack direction='row' spacing={2} style={{ marginTop: '2rem' }}>
				...
				<Button
					...
					variant='outlined'
					endIcon={<GitHub />}
					href='https://github.com/duchannes19/hciw'
					target='_blank'
